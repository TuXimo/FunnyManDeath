...
public class AudioController : MonoBehaviour
{
    ...
    //Functions:
    public void AudioPlayOneSound(string name)
    {
        Audio currentSound = Array.Find(sounds, sound => sound.clip.name == name);

        currentSound.source.Play();
    }
    
    public void APlayPapel()
    {
        Audio currentSound = Array.Find(sounds, sound => sound.clip.name == "Sound_PaperSliding_1");
